...
class StatsLogCompatManager private constructor(context: Context) : StatsLogManager(context) {
    ...
    private class StatsCompatLogger(
        ...
        /** Indicates the current rotation of the display. Uses [values.][Surface] */
    ...
    interface StatsLogConsumer {
        @WorkerThread
        fun consume(event: EventEnum?, atomInfo: LauncherAtom.ItemInfo?)
    }
    ...
    companion object {
        ...
        @JvmField
        val LOGS_CONSUMER: CopyOnWriteArrayList<StatsLogConsumer> = CopyOnWriteArrayList()
