...
import iamrp.dev.launcher.compose.icons.phosphor.Nut
import iamrp.dev.launcher.compose.icons.phosphor.X
...
import iamrp.dev.launcher.theme.OmegaAppTheme
import iamrp.dev.launcher.util.openURLInBrowser
...
open class ComposeSearchLayout(context: Context, attrs: AttributeSet? = null) :
    ...
    private val searchAlgorithm = RPDevAppSearchAlgorithm(mContext, true)
    ...
    override fun initializeSearch(containerView: ActivityAllAppsContainerView<*>?) {
        ...
        mSearchBarController.initialize(
            RPDevAppSearchAlgorithm(mContext, true),
            null,
            mContext.launcher,
            this
        )
