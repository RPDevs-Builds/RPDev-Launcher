...
import iamrp.dev.launcher.allapps.comparator.AppColorComparator
import iamrp.dev.launcher.allapps.comparator.AppUsageComparator
import iamrp.dev.launcher.allapps.comparator.InstallTimeComparator
...
fun openPopupMenu(view: View, rect: RectF?, vararg items: OptionsPopupView.OptionItem) {
    val launcher = RPDevLauncher.getLauncher(view.context)
