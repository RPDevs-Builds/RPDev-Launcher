...
package iamrp.dev.launcher.theme
...
import iamrp.dev.launcher.RPDevApp
import iamrp.dev.launcher.util.getColorAttr
import iamrp.dev.launcher.util.getSystemAccent
import iamrp.dev.launcher.wallpaper.WallpaperColorsCompat
import iamrp.dev.launcher.wallpaper.WallpaperManagerCompat
...
sealed class AccentColorOption {
    ...
    protected fun resolveWallpaperColor(selector: WallpaperColorsCompat.() -> Int?): Int {
        val context = RPDevApp.instance?.applicationContext ?: return LightPrimary.toArgb()
    ...
    object SystemAccent : AccentColorOption() {
        ...
        override val accentColor: Int
            get() = RPDevApp.instance?.applicationContext?.getSystemAccent(false)
                ?: LightPrimary.toArgb()
    ...
    object LauncherDefault : AccentColorOption() {
        ...
        override val accentColor: Int
            get() = RPDevApp.instance?.applicationContext?.getColorAttr(colorAccent)
                ?: LightPrimary.toArgb()
