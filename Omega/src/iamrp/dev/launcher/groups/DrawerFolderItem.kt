...
object DrawerFolderSyncUtil {
    ...
    fun syncDrawerFolderToWorkspace(
        ...
        try {
            ...
            for ((folderInfo, folderIcon) in linkedFolderMap) {
                ...
                iamrp.dev.launcher.folder.FolderSortUtil.sortFolder(folderInfo, context, modelWriter)
    ...
    fun syncWorkspaceFolderToDrawer(
        ...
        try {
            isSyncing = true
            val prefs = iamrp.dev.launcher.preferences.NeoPrefs.getInstance()
            ...
            } as? iamrp.dev.launcher.groups.category.DrawerFolders.CustomFolder ?: return
