...
package iamrp.dev.launcher.groups.ui
...
import iamrp.dev.launcher.compose.components.DialogNegativeButton
import iamrp.dev.launcher.compose.components.DialogPositiveButton
import iamrp.dev.launcher.compose.components.preferences.BasePreference
import iamrp.dev.launcher.compose.pages.ColorSelectionDialog
import iamrp.dev.launcher.flowerpot.Flowerpot
import iamrp.dev.launcher.groups.AppGroups
import iamrp.dev.launcher.groups.AppGroupsManager
import iamrp.dev.launcher.groups.category.DrawerFolders
import iamrp.dev.launcher.groups.category.DrawerTabs
import iamrp.dev.launcher.groups.category.FlowerpotTabs.Companion.KEY_FLOWERPOT
import iamrp.dev.launcher.groups.category.FlowerpotTabs.Companion.TYPE_FLOWERPOT
import iamrp.dev.launcher.preferences.NeoPrefs
import iamrp.dev.launcher.theme.AccentColorOption
...
fun EditGroupBottomSheet(
    ...
    val folderCompKey = remember(folderId) {
        ComponentKey(
            ComponentName("iamrp.dev.launcher.folder", "folder_$folderId"),
                    ...
                    onClick = {
                        ...
                        when (category) {
                            AppGroupsManager.Category.FOLDER -> {
                                ...
                                if (folderId != null) {
                                    iamrp.dev.launcher.groups.DrawerFolderSyncUtil.syncDrawerFolderToWorkspace(
                                        context = context,
                                        folderId = folderId,
                                        newTitle = title,
