...
package iamrp.dev.launcher.hotseat
...
import iamrp.dev.launcher.blur.BlurDrawable
import iamrp.dev.launcher.blur.BlurWallpaperProvider
import iamrp.dev.launcher.graphics.NinePatchDrawHelper
import iamrp.dev.launcher.preferences.NeoPrefs
import iamrp.dev.launcher.theme.AccentColorOption
import iamrp.dev.launcher.util.dpToPx
import iamrp.dev.launcher.util.runOnMainThread
...
open class CustomHotseat @JvmOverloads constructor(
    ...
    val launcher = RPDevLauncher.getLauncher(context)
