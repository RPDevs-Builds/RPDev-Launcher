...
import iamrp.dev.launcher.compose.components.ComposeBottomSheet
import iamrp.dev.launcher.icons.CustomizeIconPage
import iamrp.dev.launcher.preferences.NeoPrefs
import iamrp.dev.launcher.util.hasFlag
import iamrp.dev.launcher.util.hasFlags
import java.net.URISyntaxException

class OmegaShortcuts {
    class Customize(
        private val launcher: RPDevLauncher,
        private val appInfo: com.android.launcher3.model.data.AppInfo,
        itemInfo: ItemInfo,
        originalView: View,
    ) : SystemShortcut<RPDevLauncher>(
    ...
    companion object {
        val CUSTOMIZE = SystemShortcut.Factory<RPDevLauncher> { activity, itemInfo, originalView ->
        ...
        private fun getAppInfo(launcher: RPDevLauncher, itemInfo: ItemInfo): AppInfo? {
        ...
        val APP_UNINSTALL =
            SystemShortcut.Factory<RPDevLauncher> { launcher, itemInfo, originalView ->
                val prefs = NeoPrefs.getInstance()
