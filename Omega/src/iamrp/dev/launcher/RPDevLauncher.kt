...
import iamrp.dev.launcher.blur.WallpaperPermissionHelper
import iamrp.dev.launcher.gestures.GestureController
import iamrp.dev.launcher.gestures.VerticalSwipeGestureController
import iamrp.dev.launcher.preferences.NeoPrefs
import iamrp.dev.launcher.preferences.PreferencesChangeCallback
import iamrp.dev.launcher.shortcuts.OmegaShortcuts
...
import iamrp.dev.launcher.util.hasWallpaperAccess
...
class RPDevLauncher : Launcher(), SavedStateRegistryOwner,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RPDevApp.instance?.onLauncherAppStateCreated()
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == iamrp.dev.launcher.util.Permissions.REQUEST_PERMISSION_WALLPAPER_ACCESS) {
            if (grantResults.isNotEmpty() && grantResults[0] == android.content.pm.PackageManager.PERMISSION_GRANTED) {
                iamrp.dev.launcher.blur.BlurWallpaperProvider.getInstance(this).updateAsync()
            }
        }
    }
    ...
    override val activityResultRegistry: ActivityResultRegistry
        get() = object : ActivityResultRegistry() {
            override fun <I : Any?, O : Any?> onLaunch(
                ...
                val activity = this@RPDevLauncher
    ...
    companion object {
        @JvmStatic
        fun getLauncher(context: Context): RPDevLauncher {
            return context as? RPDevLauncher
                ?: (context as? ContextWrapper)?.baseContext as? RPDevLauncher
                ?: Launcher.getLauncher(context) as RPDevLauncher
        }
...
val Context.launcher: RPDevLauncher
