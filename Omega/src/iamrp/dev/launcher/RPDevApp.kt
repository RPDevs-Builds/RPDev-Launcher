...
import iamrp.dev.launcher.blur.BlurWallpaperProvider
import iamrp.dev.launcher.data.reposModule
import iamrp.dev.launcher.flowerpot.Flowerpot
import iamrp.dev.launcher.preferences.NeoPrefs
import iamrp.dev.launcher.preferences.NeoPrefs.Companion.prefsModule
import iamrp.dev.launcher.theme.ThemeManager
import iamrp.dev.launcher.util.minSDK
...
class RPDevApp : Application() {
    ...
    class ActivityHandler : ActivityLifecycleCallbacks {
        ...
        fun finishAll(recreateLauncher: Boolean = true) {
            HashSet(activities).forEach { if (recreateLauncher && it is RPDevLauncher) it.recreate() else it.finish() }
        }
...
val Context.neoApp get() = applicationContext as RPDevApp